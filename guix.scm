...
;;
;; Guix package definition for Cookie Rebound
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Cookie Rebound and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/Cookie Rebound")
  (synopsis "Persistent cookie vault with rebound-on-wipe")
