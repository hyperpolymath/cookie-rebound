...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `Cookie Rebound` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
| `Persistent cookie vault with rebound-on-wipe` | One-line description | `A tool for X` | flake.nix |
