...
The canonical RSR (Rhodium Standard Repository) template for new
hyperpolymath projects. Demonstrates dual-track architecture (root docs
for humans, sub-directories for machine-readable metadata), ABI/FFI
standard with Idris2+Zig, and complete CI/CD workflows.
...
* Dual-track design: human docs in root, machine metadata in
`+.machine_readable/+`
