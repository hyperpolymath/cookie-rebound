...
Replace all {{PLACEHOLDER}} values with your information:
  Cookie Rebound     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  cookie-rebound             - Repository name
  ...
  https://github.com/hyperpolymath/cookie-rebound          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/cookie-rebound/security/advisories/new)
...
- This repository (`hyperpolymath/cookie-rebound`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/cookie-rebound/security/advisories)
...
When using Cookie Rebound, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/cookie-rebound/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/cookie-rebound/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/cookie-rebound/discussions) |
...
*Thank you for helping keep Cookie Rebound and its users safe.* 🛡️
