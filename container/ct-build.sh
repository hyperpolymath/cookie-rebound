...
#
# Cookie Rebound — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: cookie-rebound-release)
