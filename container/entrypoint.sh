...
# Cookie Rebound container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping cookie-rebound..."
...
# Examples:
#   exec /app/cookie-rebound
#   exec /app/release/bin/cookie-rebound start
#   exec /app/cookie-rebound serve --host "${APP_HOST}" --port "${APP_PORT}"
